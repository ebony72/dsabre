...
\begin{scope}[xshift=-1cm]
  ...
  \draw[black!70, line width=0.7pt] (2.0,0.8) -- (2.0,0);
  \node[circle, draw=black!70, fill=black!80, minimum size=3pt,
        inner sep=0pt] at (2.0,0.8) {};
  \node[circle, draw=black!70, fill=white, minimum size=8pt,
        inner sep=0pt, font=\scriptsize] at (2.0,0) {$+$};
  \node[above, font=\scriptsize] at (2.0,0.8) {$g_3$};

  \node[below, font=\scriptsize] at (1.2,-0.65) {(a) circuit};
\end{scope}
...
\begin{scope}[xshift=4.5cm, yshift=0.9cm]
  ...
  \node[below, font=\scriptsize] at (0,-1.55) {(b) DAG};
\end{scope}
