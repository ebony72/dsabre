...
\begin{scope}[shift={(0,0)}]
  ...
  \node[font=\normalsize,gray!70] at (0.6,-0.6) {$C_0$};
\end{scope}
...
\begin{scope}[shift={(2.1,0)}]
  ...
  \node[font=\normalsize,gray!70] at (0.6,-0.6) {$C_1$};
\end{scope}
...
\begin{scope}[shift={(0,-2.1)}]
  ...
  \node[font=\normalsize,gray!70] at (0.6,-0.6) {$C_2$};
\end{scope}
...
\begin{scope}[shift={(2.1,-2.1)}]
  ...
  \node[font=\normalsize,gray!70] at (0.6,-0.6) {$C_3$};
\end{scope}
...
%% ── B-grid label ─────────────────────────────────────────────────────────────
\node[font=\normalsize, align=center] at (1.65,-4.2)
  {(a)~$2{\times}2$ B-grid\\[0.1pt]{\normalsize 4 cores,\ 64 qubits,\ 4 EPR links}};


%% ═══════════════════════════════════════════════════════════════════════════
%% H-GRID  (2x3 array of 4x4 cores)    x-offset = \hx
...
\begin{scope}[shift={(\hx+2.1,-2.1)}]
  ...
  \node[font=\normalsize,gray!70] at (0.6,-0.6) {$C_4$};
\end{scope}
...
\begin{scope}[shift={(\hx+4.2,-2.1)}]
  ...
  \node[font=\normalsize,gray!70] at (0.6,-0.6) {$C_5$};
\end{scope}
...
%% ── H-grid label ─────────────────────────────────────────────────────────────
\node[font=\normalsize, align=center] at (\hx+2.8,-4.2)
  {(b)~$2{\times}3$ H-grid\\[0.1pt]{\normalsize 6 cores,\ 96 qubits,\ 7 EPR links}};

%% ── Legend ───────────────────────────────────────────────────────────────────
% legend, spread across the full figure width so the enlarged labels
% (needed for single-column use) do not collide with one another
\node[dot,   label={[font=\normalsize,xshift=1mm]right:qubit}]     at (1.2, 0.75) {};
\node[cport, label={[font=\normalsize,xshift=1mm]right:comm port}] at (4.4, 0.75) {};
\draw[cl] (8.2,0.75) -- (9.1,0.75)
  node[right, font=\normalsize] {EPR link};
